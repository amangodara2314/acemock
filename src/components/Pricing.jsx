      ...
      <div className="flex gap-8 flex-wrap justify-center">
        ...
        <div className="bg-black border-[1px] border-gray-700 rounded text-white p-6 w-80 shadow text-center relative">
          ...
          <p className="text-gray-400 text-sm mb-4">
            Perfect for beginners to practice interview questions!
          </p>
          ...
          <ul className="mb-6 space-y-2">
            <li className="flex items-center justify-start gap-2">
              ...
              <span className="font-semibold ">
                2 Interviews Interviews Per Day
              </span>
            </li>
            <li className="flex items-center justify-start gap-2">
              <svg
          ...
          <button
            ...
            className="bg-white text-black font-semibold text-lg rounded w-full py-3"
          >
            Get Started
          </button>
        </div>
